export default {
  ...
  searchInformation: {
    ...
    totalResults: '10520000000',
    formattedTotalResults: '10,520,000,000',
  },
  items: [
    {
    ...
    },
    {
      ...
      snippet:
        "America's Most Popular Meal Kit ✓ Most 5-Star Reviews ✓ 50 Weekly Menu + Market Items ✓ Fresh & Affordable Meal Kit Delivery Service. Start Now!",
      htmlSnippet:
        'America&#39;s Most Popular Meal Kit ✓ Most 5-Star Reviews ✓ 50 Weekly Menu + Market Items ✓ Fresh &amp; Affordable Meal Kit Delivery Service. Start Now!',
      ...
      pagemap: {
        ...
        answer: [
          ...
          {
            text: 'HelloFresh has the most variety in terms of recipes - from meat & veggies, to low-carb and low-calorie options, and more. You can choose from six delicious meal plan preferences to craft your...',
          },
          {
            text: 'The cost of HelloFresh’s meal service starts at $7.99 per serving. In other words, you spend only $59.94 per week for 3 recipes a week for 2 people. Just check out our street cred on Trustpilot,...',
          },
          {
            text: 'Once a week. You can expect your meal kits to arrive between 8 am to 8 pm. We deliver anywhere in the United States, except Alaska and Hawaii.',
          },
          {
            text: 'Yes. HelloFresh offers a wide array of flavorful and nutritious menu options that cater to a range of dietary needs, making use of crisp, seasonal vegetables and other fresh produce.',
          },
          {
        ...
        metatags: [
          {
            ...
            'article:modified_time': '2022-02-02T22:17:40+00:00',
            viewport: 'width=device-width, initial-scale=1.0',
            'og:locale': 'en_US',
        ...
        metatags: [
          {
            ...
            last_mod: 'Sun, 24 Apr 2022 07:51:34 GMT',
            'dc.creator': 'HELLO!',
    ...
    },
    {
      ...
      displayLink: 'www.hellomagazine.com',
      snippet:
        'HELLO! US edition brings you the latest celebrity & royal news from the US & around the world, magazine exclusives, celeb babies, weddings, pregnancies and ...',
      htmlSnippet:
        '<b>HELLO</b>! US edition brings you the latest celebrity &amp; royal news from the US &amp; around the world, magazine exclusives, celeb babies, weddings, pregnancies and&nbsp;...',
    ...
    },
    {
      ...
      pagemap: {
        ...
        metatags: [
          {
            cluster: 'ip-10-3-3-25.us-west-2.compute.internal',
    ...
    },
    {
      ...
      htmlSnippet:
        '<b>Hello</b> Pizza is chef Ann Kim&#39;s New York style pizzeria offering pizza, salads and meatball subs for dining in, take out and delivery.',
      cacheId: 'Q3GmsqmRqr0J',
      formattedUrl: 'https://www.hellopizza.com/',
      htmlFormattedUrl: 'https://www.<b>hello</b>pizza.com/',
      pagemap: {
        cse_thumbnail: [
          {
            src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCxOO2sy3_dQgpiu2swGpwc17byzGXvJnsU2VvrdquTv5PPW8yTgBFJqo',
            width: '318',
            height: '159',
          },
        ],
        ...
        cse_image: [
          {
            src: 'https://images.getbento.com/accounts/909145b00ff31fd8d30995816ea72196/media/images/16074hello-pizza-white.png?w=1200&fit=fill&auto=compress,format&h=600&bg=EDEDF1&pad=100',
          },
        ],
      },
    },
